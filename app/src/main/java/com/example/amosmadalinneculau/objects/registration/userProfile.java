package com.example.amosmadalinneculau.objects.registration;
...
public class userProfile extends AppCompatActivity {
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if(validPassword(txtpassword.getText().toString(),txtcomfirmPassword.getText().toString()) == true && validateDOB(txtDOB.getText().toString())==true){
    ...
    public void sqlSendData(String email, String name, String password, String DOB, String Country){
